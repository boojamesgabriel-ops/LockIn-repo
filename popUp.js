...
function quickie_fifteen() {
  const output = document.querySelector('.session-output');
  output.innerHTML = ""; // clear only the output area
  ...
  output.appendChild(goal_wrapper); // append inside the output area
}
